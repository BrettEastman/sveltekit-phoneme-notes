...
export const alphabets: Alphabet[] = [french, completeFlute, messiaen, contraforte];
...
export const getUnit = (alphabet: Alphabet, slug: string): SoundUnit | undefined =>
  alphabet.units[getUnitIndex(alphabet, slug)];
