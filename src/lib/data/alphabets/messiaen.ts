...
export const messiaen: Alphabet = {
  ...
  name: "Messiaen",
  description:
    "In Olivier Messiaen’s “langage communicable” from Méditations sur le Mystère de la Sainte Trinité (1969), the composer used this alphabet to spell text into organ music, spanning from deep bass to high treble.",
  clef: "treble",
  kind: "letter",
